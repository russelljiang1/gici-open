...
public:
  ...
  // Set coordinate for GNSS residuals and PPP/RTK ambiguity validation.
  void setCoordinate(const GeoCoordinatePtr coordinate) override {
    EstimatorBase::setCoordinate(coordinate);
    if (ambiguity_resolution_) {
      ambiguity_resolution_->setCoordinate(coordinate);
    }
  }
