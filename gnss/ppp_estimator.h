...
struct PppEstimatorOptions {
  ...
  // Require exact code-bias/code-type mapping before using a pseudorange.
  bool strict_code_bias_mapping = false;

  // Print detailed code-bias mapping statistics for debugging OSB/DCB usage.
  bool log_code_bias_mapping = false;
};
